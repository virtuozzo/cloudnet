...
Devise.setup do |config|
  ...
  config.mailer_sender = ENV['MAILER_DEFAULT_WELCOME']
  ...
  # config.pepper = '22f0bbaa804b3ec6a32ef3d7db08ab69a2558eab48fd53d13cf560af0922cc679347cd439520935f220c03f9e172e1b6c764cb4889dde278fad0a71401377882'
  ...
  if Rails.env.development?
    config.otp_uri_application = 'Cloud.net Dev'
  else
