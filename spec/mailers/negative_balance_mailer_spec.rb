  ...
  describe "shutdown_warning_email_to_user" do
    ...
    context "rendering" do
      ...
      it "renders the body" do
        ...
        expect(response).to match("we shutdown all your servers after #{user.notif_before_shutdown} days")
      end
    end
  end
  ...
  describe "shutdown_action_email_to_user" do
    ...
    context "rendering" do
      ...
      it "renders the body" do
        ...
        expect(response).to match("destroy them after #{user.notif_before_destroy} days")
      end
    end
  end
  ...
  describe "destroy_warning_email_to_user" do
    ...
    context "rendering" do
      ...
      it "renders the body" do
        ...
        expect(response).to include("Your Cloud.net account balance is currently negative by #{balance}")
        expect(response).to match("we DESTROY all your servers automatically after #{user.notif_before_destroy} days")
      end
    end
  end
end
